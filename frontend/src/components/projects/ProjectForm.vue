...
<template>
  <el-form label-position="top" class="form-shell" @submit.prevent="onSubmit">
    <section class="form-section">
      ...
      <div class="form-grid form-grid--two">
        <el-form-item label="项目名称" class="field--wide">
          <el-input v-model="form.project_name" placeholder="AI IDE Monitor" />
        </el-form-item>

        <div class="status-card">
          <span class="status-card__label">任务状态</span>
          <strong>{{ form.is_active ? "启用中" : "停用中" }}</strong>
          <el-switch
      ...
      <div class="list-stack">
        ...
        >
          <div class="competitor-card__header">
            <div>
              <p class="section-label">竞品 {{ index + 1 }}</p>
              <strong>来源配置</strong>
            </div>
    ...
    <section class="form-section">
      ...
      <div class="form-grid form-grid--two">
        ...
        <el-form-item label="Feishu Webhook" class="field--wide">
          <el-input
    ...
    <div class="form-actions">
      <el-button @click="emit('cancel')">返回任务列表</el-button>
